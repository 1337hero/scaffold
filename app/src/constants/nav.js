import { RiInbox2Line, RiLayoutGridLine, RiBookOpenLine, RiSearchLine, RiNodeTree } from "@remixicon/react"

export const desk = { id: "desk", icon: RiLayoutGridLine, label: "Desk" }
export const inbox = { id: "inbox", icon: RiInbox2Line, label: "Inbox" }
export const notebooks = { id: "notebooks", icon: RiBookOpenLine, label: "Notebooks" }
