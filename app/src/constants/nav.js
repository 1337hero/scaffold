import { RiDashboardLine, RiInbox2Line, RiBookOpenLine, RiSearchLine, RiCodeSSlashLine } from "@remixicon/react"
...
export const coderNav = { id: "coder", path: "#/coder", icon: RiCodeSSlashLine, label: "Coder" }
