...
_Last updated: 2026-07-03 by PRD 13 session_
...
## Current focus
PRD 13 complete — People page with personal CRM grid/list, detail view, birthdays, kids, interaction logging, follow-ups, linked notes, and cadence slipping. PRDs 01-13 shipped; latest PR #53 closed issue #34.

## Next up
1. PRD 14 — Library page (#37).
...
## Last shipped
PRD 13: People page — `pages/People.jsx` (card/list CRM, filters, birthdays, hash-routed detail), `components/people/{PeopleFilters,PersonCard,PersonDetail,PersonForm,personUtils}.jsx/js`, queries.js extensions (people/detail/interactions/linked notes/birthdays + mutations), shared `apiFetch` 204 handling. 22/22 E2E harness checks green.

## Last verified
- `go build ./...`, `go vet ./...`, `go test ./...` — all green (8 packages)
- `bun run build` — green
- E2E harness (puppeteer on :4009, seeded temp SQLite): 22 People checks — surface/filter/search, kid birthdays, slipping indicators, interaction follow-ups, linked notes, edit/create/delete
